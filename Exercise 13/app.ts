...
let favoriteTransportations = ["Honda Car","Toyota Car","Suzuki Car"];
favoriteTransportations.forEach(favoriteTransportation => console.log(`“I would like to own a ${favoriteTransportation}"`));